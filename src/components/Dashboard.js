    ...
    return (
      <div>
        <animations.Reveal4 pose={isGraphVisible ? 'visible2' : 'hidden'} className="animations_Reveal4">
          ...
          />
          <animations.Resize
            className={graphFocus === 1 ? ('col-sm-10 graph1 graph1-highlight') : ('col-sm-10 graph1')}
            pose={pose}
        ...
        {freshReveal && (
          <animations.Reveal3
            className={graphFocus === 1 ? ('col-sm-10 graph2 animations_Reveal3') : ('col-sm-10 graph2 animations_Reveal3 graph2-highlight')}
            pose={pose2}
